...
import com.google.android.m4b.maps.GoogleMap.OnIndoorStateChangeListener;
...
import com.google.android.m4b.maps.GoogleMap.OnMapLongClickListener;
...
import com.google.android.m4b.maps.GoogleMap.OnMyLocationButtonClickListener;
...
public class GoogleMaps extends CordovaPlugin implements View.OnClickListener, OnMarkerClickListener,
  ...
  private void isAvailable(final JSONArray args, final CallbackContext callbackContext) throws JSONException {
    ...
    try {
      @SuppressWarnings({ "rawtypes" })
      Class GoogleMapsClass = Class.forName("com.google.android.m4b.maps.GoogleMap");
    } catch (Exception e) {
